...
namespace Snm.Runtime.DebugDraw
{
    ...
    public static class DebugDraw
    {
        ...
        {
            if (!DebugDrawManager.Enabled) return null;
            return DebugDrawManager.Shapes.Ring(center, normal, radius, color, thickness);
        }
        ...
        {
            if (!DebugDrawManager.Enabled) return null;
            return DebugDrawManager.Shapes.Cone(origin, direction, angleDeg, length, color);
        }
        ...
        {
            if (!DebugDrawManager.Enabled) return null;
            return DebugDrawManager.Shapes.Frustum(camera, color);
        }
        ...
        {
            if (!DebugDrawManager.Enabled) return null;
            return DebugDrawManager.Labels.Show(textGetter, target, offset, color, autoUpdate: true);
        }
        ...
        {
            if (!DebugDrawManager.Enabled) return null;
            return DebugDrawManager.Labels.Show(() => text, target, offset, color, autoUpdate: false);
        }
        ...
        {
            if (!DebugDrawManager.Enabled) return null;
            return DebugDrawManager.Labels.Show(() => text, worldPos, null, color, autoUpdate: false);
        }

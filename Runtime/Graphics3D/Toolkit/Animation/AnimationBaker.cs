    ...
    public class AnimationBaker
    {
            ...
            Dictionary<AnimationClip, UnityEngine.AnimationEvent[]> cacheAnimationEvent)
        {
            ...
            for (int i = 0; i != stateMachine.states.Length; ++i)
            {
                ...
                bake.info = new Graphics3D.GPUSkinning.AnimationInfo
                {
                ...
                bake.info.eventList = new List<Graphics3D.GPUSkinning.AnimationEvent>();
                foreach (var evt in clip.events)
                {
                    var aniEvent = new Graphics3D.GPUSkinning.AnimationEvent
                    {
        ...
        private static void GenerateAnimationPoseData(
            ...
            out List<Graphics3D.GPUSkinning.AnimationInfo> animInfoList,
            out List<AnimationPoseData> animPoseDataList)
        {
            animInfoList = new List<Graphics3D.GPUSkinning.AnimationInfo>();
        ...
        private class AnimationBakeInfo
        {
            ...
            public float length;
            public int layer;
            public Graphics3D.GPUSkinning.AnimationInfo info;
        }

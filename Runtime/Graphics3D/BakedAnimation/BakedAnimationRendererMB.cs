...
namespace Snm.Graphics3D.GPUSkinning
{
    ...
    public class BakedAnimationRendererMB : MonoBehaviour
    {
        ...
        /// <summary>
        /// When true, LateUpdate skips rendering. Used by preview windows to avoid double-drawing.
        /// </summary>
        [System.NonSerialized] public bool SuppressRendering;
        ...
        private void Setup()
        {
            ...
            _bindposes = _runtimeMesh.bindposes;
        }
        ...
        {
            if (_player == null || _runtimeMaterial == null || _runtimeMesh == null) return;
            if (SuppressRendering) return;

            _player.Update(Time.deltaTime);

            if (!_hasOverrides && useInstancing && Application.isPlaying)
            {
                GPUSkinInstanceBatcher.Instance.Submit(
                    _runtimeMesh, _runtimeMaterial,
            ...
            else
            {
                ...
                Graphics.DrawMesh(_runtimeMesh, transform.localToWorldMatrix, mat,
        ...
        /// <summary>
        /// Packs Mesh.boneWeights into TEXCOORD1 (weights) and TEXCOORD2 (indices)
        /// so the GPU skinning shader can read them as vertex attributes.
        /// </summary>
        internal static void UploadBoneWeightsToUV(Mesh mesh)
        {

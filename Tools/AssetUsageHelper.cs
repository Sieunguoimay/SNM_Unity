...
namespace Snm.Tools
{
    static class AssetUsageHelper
    {

        public static void LogAssetUsages(Object obj, IEnumerable<string> dependents)
        {
            Debug.Log($"Usages of {AssetDatabase.GetAssetPath(obj)}: ", obj);

            foreach (var d in dependents)
            {
                Debug.Log(d, AssetDatabase.LoadAssetAtPath<Object>(d));
            }
        }

        public static IEnumerable<string> GetAllDependents(Object obj, IEnumerable<string> assetPaths)
        {
            if (obj != null)
            {

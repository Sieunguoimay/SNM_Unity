...
namespace Snm.Tools.Finders
{
    public class AssetReferenceFinderWindow : EditorWindow
    {
        ...
        [MenuItem("Tools/Snm/Finders/Find References In Project")]
        public static void Open()
        {
            var window = GetWindow<AssetReferenceFinderWindow>("Asset Reference Finder");
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.PropertyField(so.FindProperty(nameof(searchRoots)));
            EditorGUILayout.Space();
            EditorGUILayout.PropertyField(so.FindProperty(nameof(targetRoots)));
        ...
        // private void DrawObjectList(string label, string listName)
        // {

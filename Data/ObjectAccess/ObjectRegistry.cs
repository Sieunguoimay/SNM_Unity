...
namespace ObjectAccess
{
    public class ObjectRegistry : ScriptableObject
    {
        ...
        // private Dictionary<string, ObjectEntry> _entriesByName;
        // private Dictionary<string, ObjectEntry> EntriesByName
        // {
        //     get
        //     {
        //         if (_entriesByName == null)
        //         {
        //             _entriesByName = Entries.ToDictionary(e => e.name, e => e);
        //         }
        ...
        // public void Register(string entryName, object obj)
        // {
        //     if (!EntriesByName.TryGetValue(entryName, out var e))
        //     {
        //         Debug.LogError($"ObjectRegistry: Failed to Register {entryName}! Entry does not exist.");
        //     }
        //     else
        //     {
        //         Register(e, obj);
        ...
        //     else
        //     {
        //         Debug.LogError($"ObjectRegistry: Failed to Unegister! Entry {entryName} not found");
        //     }
        // }
        ...
        // public bool TryGetObject<TObject>(string entryName, out TObject obj)
        // {
        //     if (EntriesByName.TryGetValue(entryName, out var e))
        //     {
        //         return TryGetObject(e, out obj);
        //     }
        //     else
        //     {
        //         Debug.LogError($"Failed to GetObject!. Entry {entryName} does not exist.");
        //     }
        //     obj = default;
        //     return false;
        // }
